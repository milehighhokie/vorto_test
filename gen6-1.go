...
func firstLoadProcessing(loadList []int, loads map[int]load) ([]truck) {
...
func reverseLoadProcessing(loadList []int, loads map[int]load) ([]truck) {
	maxTrucks := len(loadList)
	trucks :=  make([]truck, maxTrucks) 
...
func main() {
	...
	firstLoadTrucks := firstLoadProcessing(loadList,loads)
	reverseLoadTrucks := reverseLoadProcessing(loadList,loads)
